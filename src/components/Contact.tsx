...
export const Contact: React.FC = () => {
  ...
  const [address] = useLocalStorage('address', '122 Lê Thánh Tôn, phường Bến Thành, Quận 1 Ho Chi Minh City, Vietnam 70000');
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <a
              href="https://maps.app.goo.gl/mJBNFZcvo4DVRdjT6"
              target="_blank"
